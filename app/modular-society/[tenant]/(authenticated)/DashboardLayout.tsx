...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  if (loading) return <Box sx={{ p: 4 }}>Loading Ecosystem Engine...</Box>;
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      >
        <Box sx={{ p: 3 }}>
          <Typography variant="h5" sx={{ fontWeight: 900 }} color="primary">Society OS</Typography>
        </Box>
        <List sx={{ px: 2 }}>
          <ListItem disablePadding sx={{ mb: 1 }}>
            <ListItemButton component={Link} href="/updates" sx={{ borderRadius: 2 }}>
              <ListItemIcon><DynamicFeedIcon color="primary" /></ListItemIcon>
              <ListItemText primary="Updates" slotProps={{ primary: { sx: { fontWeight: 'bold' } } }} />
            </ListItemButton>
          </ListItem>
          ...
          <ListItem disablePadding sx={{ mb: 1 }}>
            <ListItemButton component={Link} href="/trade" sx={{ borderRadius: 2 }}>
              ...
              <ListItemText primary="Trade" slotProps={{ primary: { sx: { fontWeight: 'bold' } } }} />
            </ListItemButton>
          </ListItem>
          ...
          <ListItem disablePadding sx={{ mb: 1 }}>
            <ListItemButton component={Link} href="/meet" sx={{ borderRadius: 2 }}>
              ...
              <ListItemText primary="Meet" slotProps={{ primary: { sx: { fontWeight: 'bold' } } }} />
            </ListItemButton>
          </ListItem>
          ...
          <ListItem disablePadding sx={{ mb: 1 }}>
            <ListItemButton component={Link} href="/learn" sx={{ borderRadius: 2 }}>
              ...
              <ListItemText primary="Learn" slotProps={{ primary: { sx: { fontWeight: 'bold' } } }} />
            </ListItemButton>
          </ListItem>
          ...
          <ListItem disablePadding sx={{ mb: 1 }}>
            <ListItemButton component={Link} href="/support" sx={{ borderRadius: 2 }}>
              ...
              <ListItemText primary="Support" slotProps={{ primary: { sx: { fontWeight: 'bold' } } }} />
            </ListItemButton>
          </ListItem>
        </List>
      </Drawer>
