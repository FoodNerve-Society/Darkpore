...
export const ECOSYSTEM_EVENT_TYPES: EcosystemEventType[] = [
  ...
  { id: 'livestream', label: 'Livestream', tab: 'learn', description: 'Host a live video session.', isActive: true, orgOnly: true },
  ...
  { id: 'group-buy', label: 'Group-Buy', tab: 'trade', description: 'Pool resources to share costs.', isActive: false },
  { id: 'swap', label: 'Swap/Barter', tab: 'trade', description: 'Trade goods directly without cash.', isActive: false },
  { id: 'opportunities', label: 'Opportunities', tab: 'trade', description: 'Grants, RFPs, fellowships.', isActive: false },
